class Review {
  ...
  Review({this.id, this.page, this.results, this.totalPages, this.totalResults});
  ...
  Review.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((map) {
        results.add(new MovieDetails.fromJson(map));
      });
    }
...
class MovieDetails {
  ...
  MovieDetails({this.author, this.authorDetails, this.content, this.createdAt, this.id, this.updatedAt, this.url});
